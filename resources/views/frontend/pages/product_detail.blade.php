...
@endsection
@section('title','PUPPIES HUND || Detalles Productos')
					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="">Detalle Productos</a></li>
							</ul>
						</div>
					</div>
				</div>
											...
											<div class="product-buy">
												<form action="{{route('single-add-to-cart')}}" method="POST">
													...
													<div class="add-to-cart mt-4">
														...
														<a href="{{route('add-to-wishlist',$product_detail->slug)}}" class="btn min"><i class="ti-heart" title="favorito"></i></a>
													</div>
												</form>
														...
														<div class="row">
															<div class="col-12">
																...
																<p class="text-center p-5">
																	Necesitas <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Iniciar Sesión</a> O <a style="color:blue" href="{{route('register.form')}}">Registrar</a>
