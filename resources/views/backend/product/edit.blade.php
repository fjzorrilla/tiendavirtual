    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Nombre del Productos"  value="{{$product->title}}" class="form-control">
          @error('title')
        ...
        <div class="form-group">
          ...
          <input id="price" type="number" name="price" placeholder="Precio en Soles"  value="{{$product->price}}" class="form-control">
          @error('price')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <select name="brand_id" class="form-control">
              <option value="">--Selececiona Marcas--</option>
