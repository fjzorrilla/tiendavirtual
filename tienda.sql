...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-05-2021 a las 01:05:01
...
INSERT INTO `carts` (`id`, `product_id`, `order_id`, `user_id`, `price`, `status`, `quantity`, `amount`, `suscription_id`, `created_at`, `updated_at`) VALUES
(1, 5, NULL, 2, 0.00, 'new', 0, 0.00, 1, '2021-05-22 03:00:57', '2021-05-22 03:00:57'),
(2, 3, NULL, 2, 0.00, 'new', 0, 0.00, 1, '2021-05-22 03:00:57', '2021-05-22 03:00:57');
...
(1, 'Perros', 'perros', NULL, NULL, 1, NULL, NULL, 'active', '2020-08-14 04:26:15', '2021-05-19 22:02:59'),
(2, 'Gatos', 'gatos', '<p><br></p>', '/storage/photos/1/Category/mini-banner2.jpg', 1, NULL, NULL, 'active', '2020-08-14 04:26:40', '2021-04-18 04:53:40'),
(15, 'Humano / Mascota', 'humano-mascota', '<p><br></p>', NULL, 1, NULL, NULL, 'active', '2021-04-19 22:27:30', '2021-04-19 22:27:30'),
(16, 'Alimento', 'alimento', NULL, NULL, 0, 1, NULL, 'active', '2021-04-19 22:33:18', '2021-04-19 22:33:18'),
(17, 'Alimento Seco', 'alimento-seco', NULL, NULL, 0, 16, NULL, 'active', '2021-04-19 22:33:38', '2021-04-19 22:33:38'),
(18, 'Alimento Humedo', 'alimento-humedo', NULL, NULL, 0, 16, NULL, 'active', '2021-05-22 00:31:50', '2021-05-22 00:31:50'),
(19, 'Juguetes', 'juguetes', NULL, NULL, 0, 1, NULL, 'active', '2021-05-22 00:47:20', '2021-05-22 00:47:20'),
(20, 'Platicos', 'platicos', NULL, NULL, 0, 19, NULL, 'active', '2021-05-22 00:48:00', '2021-05-22 00:48:00'),
(21, 'Prueba', 'prueba', '<p><br></p>', NULL, 0, 1, NULL, 'active', '2021-05-22 00:56:08', '2021-05-22 00:56:08'),
(22, 'Prueba 2', 'prueba-2', NULL, NULL, 0, 21, NULL, 'active', '2021-05-22 00:56:20', '2021-05-22 00:56:20');
...
(3, 'Prajwal Rai', 'lorem ipsum', 'prajwal.iar@gmail.com', NULL, '1200990009', 'hello sir sdfdfd dfdjf ;dfjd fd ldkfd', '2021-04-18 06:31:47', '2020-08-17 21:15:12', '2021-04-18 06:31:47');
...
('5db41c31-6fa7-4b2a-a162-2c91cffef157', 'App\\Notifications\\StatusNotification', 'App\\User', 1, '{\"title\":\"New Product Rating!\",\"actionURL\":\"http:\\/\\/127.0.0.1:8000\\/product-detail\\/white-sports-casual-t\",\"fas\":\"fa-star\"}', NULL, '2021-04-17 02:42:30', '2021-04-17 02:42:30'),
...
('665f683c-c903-4dce-89b7-78accf7eb09a', 'App\\Notifications\\StatusNotification', 'App\\User', 1, '{\"title\":\"New order created\",\"actionURL\":\"http:\\/\\/127.0.0.1:8000\\/admin\\/order\\/6\",\"fas\":\"fa-file-alt\"}', NULL, '2021-04-16 02:25:46', '2021-04-16 02:25:46'),
...
('b07e50f9-20c3-4d3d-a7df-26206cee2828', 'App\\Notifications\\StatusNotification', 'App\\User', 1, '{\"title\":\"New order created\",\"actionURL\":\"http:\\/\\/127.0.0.1:8000\\/admin\\/order\\/1\",\"fas\":\"fa-file-alt\"}', NULL, '2021-04-23 21:18:37', '2021-04-23 21:18:37'),
...
(1, 'ORD-Z46J0XWAMM', 2, 1540.00, 4, NULL, 1940.00, 3, 'cod', 'unpaid', 'delivered', 'Junior', 'Lopez', 'user@gmail.com', '123213123', 'NP', NULL, '123123123', NULL, '2021-04-23 21:18:37', '2021-05-19 19:52:52');
...
CREATE TABLE `products` (
  ...
  `condition` enum('superpremium','regular','premium') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'regular',
  `status` enum('active','inactive') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'inactive',
  `price` double(8,2) NOT NULL,
...
(3, 30, 2, 5, 'Prubas', 'inactive', '2021-04-17 02:42:30', '2021-04-17 02:43:15');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `product_suscriptions`
--

CREATE TABLE `product_suscriptions` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `product_suscriptions`
--
...
(30, 8, 1, '2021-05-21 21:48:34', '2021-05-21 21:48:34'),
(31, 7, 1, '2021-05-21 21:48:34', '2021-05-21 21:48:34'),
(32, 6, 1, '2021-05-21 21:48:34', '2021-05-21 21:48:34'),
(33, 5, 1, '2021-05-21 21:48:34', '2021-05-21 21:48:34'),
(34, 4, 1, '2021-05-21 21:48:34', '2021-05-21 21:48:34'),
(35, 3, 1, '2021-05-21 21:48:34', '2021-05-21 21:48:34');
...
CREATE TABLE `suscriptions` (
  ...
  `premium` decimal(20,0) DEFAULT NULL,
  `superpremium` decimal(20,0) DEFAULT NULL,
  `regular` decimal(20,0) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 'Suscripcion 1', 'suscripcion-1', '/storage/photos/1/blog3.jpg', 'active', '900', '1300', '800', '2021-05-19 20:14:14', '2021-05-21 21:48:33'),
...
(1, 'Administrador', 'admin@gmail.com', NULL, '$2y$10$GOGIJdzJydYJ5nAZ42iZNO3IL1fdvXoSPdUOH3Ajy5hRmi0xBmTzm', '/storage/photos/1/users/user1.jpg', 'admin', NULL, NULL, 'active', 'SoTy3xpZ2O7HTUo86fTJvsomCcEQihAGTYtOvzoAj7F0kht4HHrsSw85uxks', NULL, '2021-04-16 01:09:14'),
...
(30, 'Junior Lopez', 'jlopezmatadevelop@gmail.com', NULL, '$2y$10$XP0PA.sgFDV8ZfZUTKtODuRl7Ak6hBR4BaLspVHQWVb05DZrpMbJq', '/storage/photos/30/IMG_20210213_152837_1.jpg', 'user', NULL, NULL, 'active', NULL, '2021-04-16 02:34:44', '2021-04-17 02:40:32');
...
--
-- Indices de la tabla `product_suscriptions`
--
