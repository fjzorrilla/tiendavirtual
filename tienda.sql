...
(1, 'Perros', 'perros', NULL, NULL, 0, NULL, NULL, 'active', '2020-08-14 04:26:15', '2021-05-19 22:02:59'),
...
CREATE TABLE `products` (
  ...
  `condition` enum('default','regular','premium') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default',
  `status` enum('active','inactive') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'inactive',
  `price` double(8,2) NOT NULL,
